...
if (isset($_POST['dangky']) && isset($_POST['name']) != '' && isset($_POST['phone']) != '' &&
    isset($_POST['address']) != '' && isset($_POST['email']) != '' && isset($_POST['username']) != '' &&
    ...
    $result = $customerController->registerUser($name, $phone, $address, $email, $username, $password);
        ...
        <div class="form-container">
            <form action="register.php" method="post">
                ...
                <div class="form-group text-center">
                    Bạn đã có tài khoản? <a href="../view/customer_login.php" class="login-link">Đăng nhập</a>
                </div>
            </form>
        </div>
    </div>
